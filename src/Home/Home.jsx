...
// Class de modélisation des données
import User from "../models/User.js";

// Components
import AverageSession from "../AverageSession/AverageSession.jsx";
...
export default function Home() {
    ...
    if(user) {
        return (
            <React.Fragment>
                <header>
                <img src={logo} alt="Logo SportSee" id="logo"/>
            ...
            <main>
                ...
                <div id="cards">
                    <div id="charts">
                        <div className="card" id="dailyActivity">
                            <DailyActivity id={user.id}/>
                        </div>
                        

                        <div className="card" id="averageSession">
                            <AverageSession id={user.id} />
                        </div>

                        <div className="card" id="performances">
                            <Performances id={user.id} />
                        </div>

                        <div className="card" id="goalProgress">
                            <GoalProgress progress={user.score}/>
                        </div>
                    ...
                    <div id="stats">
                        <div className="card" id="calories">
                            ...
                            <span className="infos">
                                {user.nutri && <em>{user.nutri.calorieCount + 'kCal'}</em>}
                                <p>Calories</p>
                            </span>
                        </div>
                        <div className="card" id="proteins">
                            <div className="svgContainer">
                            ...
                            <span className="infos">
                                {user.nutri && <em>{user.nutri.proteinCount + 'g'}</em>}
                                <p>Protéines</p>
                            </span>
                        </div>
                        <div className="card" id="carbohydrates">
                            <div className="svgContainer">
                            ...
                            <span className="infos">
                                {user.nutri && <em>{user.nutri.carbohydrateCount + 'g'}</em>}
                                <p>Glucides</p>
                            </span>
                        </div>
                        <div className="card" id="lipids">
                            <div className="svgContainer">
                            ...
                            <span className="infos">
                                {user.nutri && <em>{user.nutri.lipidCount + 'g'}</em>}
                                <p>Lipides</p>
                            </span>
                        </div>
                    </div>
